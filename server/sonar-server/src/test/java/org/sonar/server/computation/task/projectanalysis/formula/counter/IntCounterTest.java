...
public class IntCounterTest {
  ...
  public void newly_created_IntVariationValue_is_unset_and_has_value_0() {
    verifyUnsetVariationValue(new IntCounter());
  }

  @Test
  public void increment_int_sets_IntVariationValue_and_increments_value() {
    verifySetVariationValue(new IntCounter().increment(10), 10);
  }

  @Test
  public void increment_IntVariationValue_has_no_effect_if_arg_is_null() {
    verifyUnsetVariationValue(new IntCounter().increment(null));
  }

  @Test
  public void increment_IntVariationValue_has_no_effect_if_arg_is_unset() {
    verifyUnsetVariationValue(new IntCounter().increment(new IntCounter()));
  }

  @Test
  public void increment_IntVariationValue_increments_by_the_value_of_the_arg() {
    IntCounter source = new IntCounter().increment(10);
    IntCounter target = new IntCounter().increment(source);
  ...
  public void multiple_calls_to_increment_IntVariationValue_increments_by_the_value_of_the_arg() {
    IntCounter target = new IntCounter()
      .increment(new IntCounter().increment(35))
      .increment(new IntCounter().increment(10));
  ...
  public void multiples_calls_to_increment_int_increment_the_value() {
    IntCounter variationValue = new IntCounter()
      .increment(10)
      .increment(95);
  ...
  private static void verifyUnsetVariationValue(IntCounter variationValue) {
    assertThat(variationValue.isSet()).isFalse();
    assertThat(variationValue.getValue()).isEqualTo(0);
  }

  private static void verifySetVariationValue(IntCounter variationValue, int expected) {
