...
public class PeriodsHolderImplTest {
  ...
  @Test
  public void hasPeriod_returns_true_only_if_holder_contains_a_period() {
    PeriodsHolderImpl periodsHolder = new PeriodsHolderImpl();

    periodsHolder.setPeriod(createPeriod());

    assertThat(periodsHolder.hasPeriod()).isTrue();
  }

  private static Period createPeriod() {
    return new Period("mode", null, 1000L, "U1");
  }
}
